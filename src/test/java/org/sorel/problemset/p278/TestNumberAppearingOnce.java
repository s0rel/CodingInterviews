...
public class TestNumberAppearingOnce {
    ...
    public void test01() {
        ...
        Assert.assertEquals(3, sol.findNumberAppearOnce(numbers));
    }
    ...
    public void test02() {
        ...
        Assert.assertEquals(4, sol.findNumberAppearOnce(numbers));
    }
    ...
    public void test03() {
        ...
        Assert.assertEquals(7, sol.findNumberAppearOnce(numbers));
    }
    ...
    public void test04() {
        ...
        Assert.assertEquals(-10, sol.findNumberAppearOnce(numbers));
    }
    ...
    public void test05() {
        ...
        Assert.assertEquals(3467, sol.findNumberAppearOnce(numbers));
    }
    ...
    public void test06() {
        ...
        Assert.assertEquals(1023, sol.findNumberAppearOnce(numbers));
    }
    ...
    public void test08() {
        ...
        Assert.assertEquals(0, sol.findNumberAppearOnce(numbers));
    }
